...
<html lang="en">
  <head>
    ...
    <link href="<?php echo e(asset('css/csshome/style.css')); ?>" rel="stylesheet" />
  </head>
  ...
  <body>
        ...
        >
          ...
          >
            <div class="navbar-nav ml-auto py-0">
              <a href="<?php echo e(route('customer.home')); ?>" class="nav-item nav-link active">Home</a>
              <a href="<?php echo e(route('customer.about')); ?>" class="nav-item nav-link">About</a>
              <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu border-0 rounded-0 m-0">
                  <a href="<?php echo e(route('customer.profilecust')); ?>" class="dropdown-item">My Profile</a>
                  <a href="<?php echo e(route('customer.logout')); ?>" class="dropdown-item">Logout</a>
                </div>
              </div>
              <a href="<?php echo e(route('customer.contact')); ?>" class="nav-item nav-link">Contact</a>
            </div>
          </div>
        </nav>
      </div>
    ...
    <div class="container-fluid py-5">
      <div class="container pt-0 pt-lg-4">
        <div class="row align-items-center">
          <div class="col-lg-5">
            <img class="img-fluid" src="<?php echo e(asset('img/about.jpg')); ?>" alt="" />
          </div>
        ...
        <div class="owl-carousel testimonial-carousel">
          <div class="testimonial-item">
            <img
              ...
              src="<?php echo e(asset('img/testimonial-1.jpg')); ?>"
              style="
                width: 100px;
                height: 100px;
                padding: 12px;
          ...
          <div class="testimonial-item">
            <img
              class="position-relative rounded-circle bg-white shadow mx-auto"
              src="<?php echo e(asset('img/testimonial-2.jpg')); ?>"
              style="
                width: 100px;
                height: 100px;
                padding: 12px;
          ...
          <div class="testimonial-item">
            <img
              class="position-relative rounded-circle bg-white shadow mx-auto"
              src="<?php echo e(asset('img/testimonial-3.jpg')); ?>"
              style="
                width: 100px;
                height: 100px;
                padding: 12px;
          ...
          <div class="testimonial-item">
            <img
              class="position-relative rounded-circle bg-white shadow mx-auto"
              src="<?php echo e(asset('img/testimonial-4.jpg')); ?>"
              style="
                width: 100px;
                height: 100px;
                padding: 12px;
    ...
    <script src="<?php echo e(asset('js/mail/jqBootstrapValidation.min.js')); ?>"></script>
    <script src="<?php echo e(asset('js/mail/contact.js')); ?>"></script>

    <!-- Template Javascript -->
    <script src=" <?php echo e(asset('js/main.js')); ?>"></script>
  </body>
</html>
<?php /**PATH C:\Users\LENOVO\Documents\.UTAMA\SEMESTER 4\2. MBD\FP\FPMBD_LaundryDar\resources\views/homecust.blade.php ENDPATH**/ ?>