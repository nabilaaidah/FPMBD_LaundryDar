        ...
        >
          ...
          >
            <div class="navbar-nav ml-auto py-0">
              <a href="<?php echo e(route('customer.home')); ?>" class="nav-item nav-link">Home</a>
              ...
              <a href="<?php echo e(route('customer.contact')); ?>" class="nav-item nav-link active"
                >Contact</a
              >
            </div>
          </div>
      ...
      <div class="container py-5">
        <div class="row align-items-center py-4">
          ...
          <div class="col-md-6 text-center text-md-right">
            <div class="d-inline-flex align-items-center">
              <a class="btn text-white" href="<?php echo e(route('customer.home')); ?>">Home</a>
              <i class="fas fa-angle-right text-white"></i>
              <a class="btn text-white disabled" href="<?php echo e(route('customer.contact')); ?>"
                >Contact Us</a
              >
            </div>
          </div>
            ...
            <div class="row">
              <div class="col-md-4">
                ...
                >
                  ...
                  <h5 class="font-weight-medium m-0 mt-2">
                    Jl. Keputih Perintis IA No.42A
                  </h5>
                </div>
              </div>
              <div class="col-md-4">
...
<?php /**PATH C:\Users\LENOVO\Documents\.UTAMA\SEMESTER 4\2. MBD\FP\FPMBD_LaundryDar\resources\views/contact.blade.php ENDPATH**/ ?>