        ...
        >
          ...
          >
            <div class="navbar-nav ml-auto py-0">
              <a href="<?php echo e(route('customer.login')); ?>" class="nav-item nav-link">Home</a>
              <a href="<?php echo e(route('customer.about')); ?>" class="nav-item nav-link active">About</a>
              <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu border-0 rounded-0 m-0">
                  ...
                  <a href="<?php echo e(route('customer.logout')); ?>" class="dropdown-item">Log Out</a>
                </div>
              </div>
        ...
        <div class="row align-items-center py-4">
          ...
          <div class="col-md-6 text-center text-md-right">
            <div class="d-inline-flex align-items-center">
              ...
              <a class="btn text-white disabled" href="<?php echo e(route('customer.about')); ?>">About Us</a>
            </div>
          </div>
        </div>
      </div>
...
<?php /**PATH C:\Users\LENOVO\Documents\.UTAMA\SEMESTER 4\2. MBD\FP\FPMBD_LaundryDar\resources\views/about.blade.php ENDPATH**/ ?>