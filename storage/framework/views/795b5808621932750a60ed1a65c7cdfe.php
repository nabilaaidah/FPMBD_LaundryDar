            ...
            <div class="navbar-nav ml-auto py-0">
              ...
              <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu border-0 rounded-0 m-0">
                  <a href="<?php echo e(route('customer.profilecust')); ?>" class="dropdown-item active"
                    >My Profile</a
                  >
        ...
        <div class="row align-items-center py-4">
          ...
          <div class="col-md-6 text-center text-md-right">
            <div class="d-inline-flex align-items-center">
              ...
              <a class="btn text-white disabled" href="<?php echo e(route('customer.profilecust')); ?>">Profile</a>
            </div>
          </div>
        </div>
      </div>
...
<?php /**PATH C:\Users\LENOVO\Documents\.UTAMA\SEMESTER 4\2. MBD\FP\FPMBD_LaundryDar\resources\views/profilecust.blade.php ENDPATH**/ ?>