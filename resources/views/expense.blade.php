    ...
    <div class="container-fluid position-relative bg-white d-flex p-0">
      ...
      <div class="content">
        ...
        <div class="container-fluid pt-4 px-4">
                  <div class="bg-light text-center rounded p-4">
                    ...
                    <div class="table-responsive">
                      ...
                      >
                        <thead>
                          <tr class="text-dark">
                            <th scope="col">Nama Expense</th>
                            <th scope="col">Price Expence</th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{ $expense->exp_totalexpense }}</td>
        ...
        <div class="btns-group">
          <input type="button" value="Add Expense" class="btn" onclick="addExpense()" />
        </div>

        <script>
          function addExpense() {
            window.location.href = "{{ route('admin.expense', ['employeeId' => $employeeId]) }}";
          }
        </script>
        <!-- Form Employee End -->
