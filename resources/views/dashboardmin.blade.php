                  ...
                  <div class="bg-light text-center rounded p-4">
                    ...
                    <div class="table-responsive">
                      ...
                      >
                        <thead>
                          <tr class="text-dark">
                            <th scope="col">Tsc_id</th>
                            <th scope="col">Tsc_status</th>
                            <th scope="col">Tsc_tglmasuk</th>
                            <th scope="col">Tsc_tglselesai</th>
                            <th scope="col">Cst_id</th>
                          </tr>
                        </thead>
                        <tbody>
                      ...
                      >
                        <thead>
                          <tr class="text-dark">
                            ...
                            <th scope="col">Div_date</th>
                            <th scope="col">Div_address</th>
                            <th scope="col">Tsc_id</th>
                          </tr>
                        </thead>
                        <tbody>
