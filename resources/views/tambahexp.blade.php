...
<html lang="en">
  <head>
    ...
    <link
      href="{{ asset('libadmin/owlcarousel/assets/owl.carousel.min.css') }}"
      rel="stylesheet"
    />
    <link
  ...
  <body>
    <form action="{{ route('expense.store', ['employeeId' => $employeeId]) }}" method="POST" class="form">
    @csrf
              ...
              <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                ...
                >
                  <a href="dashboardmin.html" class="">
                    <h3 class="text-primary">
                      <i class="fa fa-hashtag me-2"></i>Expense
                    </h3>
                  </a>
                  <!-- <h3></h3> -->
                </div>
                ...
                <div class="form-floating mb-3">
                  <input
                    ...
                    required
                  />
                  <label for="floatingInput">Nama Expense</label>
                </div>
                ...
                <div class="form-floating mb-3">
                  <input
                    ...
                    name="exp_totalexpense"
                    placeholder="Total Expense"
                    required
                  />
                  <label for="floatingTotalExpense">Total Expense</label>
                </div>
