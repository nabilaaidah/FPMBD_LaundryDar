    ...
    <div class="container-fluid position-relative bg-white d-flex p-0">
      ...
      <div class="content">
                      ...
                      >
                        <thead>
                          <tr class="text-dark">
                            ...
                            <th scope="col">Price Perkilo</th>
                          </tr>
                        </thead>
                        <tbody>
                            @foreach ($service as $services)
                            <tr>
                                <th>{{ $services->svc_name }}</th>
                                <th>{{ $services->svc_priceperkilo }}</th>
                            </tr>
                            @endforeach
                        </tbody>
                      </table>
        ...
        <div class="btns-group">
          <input type="button" value="Add Service" class="btn" onclick="addService()" />
        </div>

        <script>
          function addService() {
            window.location.href = "{{ route('service.showaddserviceform', ['employeeId' => $employeeId]) }}";
          }
        </script>
